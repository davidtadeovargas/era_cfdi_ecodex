 ...
 *       &lt;sequence>
 *         &lt;element name="ListaCancelar" type="{http://Ecodex.WS.Model/2011/CFDI}ListaCancelar" minOccurs="0"/>
...
@XmlRootElement(name = "SolicitudCancelaMultiple")
public class SolicitudCancelaMultiple {

    @XmlElementRef(name = "ListaCancelar", namespace = "http://Ecodex.WS.Model/2011/CFDI", type = JAXBElement.class, required = false)
    protected JAXBElement<ListaCancelar> listaCancelar;
    ...
    /**
     * Obtiene el valor de la propiedad listaCancelar.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ListaCancelar }{@code >}
     *     
     */
    public JAXBElement<ListaCancelar> getListaCancelar() {
        return listaCancelar;
    }

    /**
     * Define el valor de la propiedad listaCancelar.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link ListaCancelar }{@code >}
     *     
     */
    public void setListaCancelar(JAXBElement<ListaCancelar> value) {
        this.listaCancelar = value;
    }
